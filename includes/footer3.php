<div class="bg-noirb dark:bg-noird">
    ...
    <div class="grid row-gap-10 mb-8 lg:grid-cols-6">
      ...
      <div class="md:max-w-md lg:col-span-2">
        ...
        <form class="flex flex-col mt-4 md:flex-row">
          ...
          <button
            type="submit"
            class="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-blue-500 focus:shadow-outline focus:outline-none"
          >
            Subscribe
          </button>
        </form>
