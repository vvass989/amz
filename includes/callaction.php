        ...
        <div class="justify-center text-center gap-6 md:text-left md:flex lg:items-center  lg:gap-16">
            ...
            <div class="md:w-5/12 lg:w-6/12">
                ...
                <div class="group bg-white dark:bg-noirb  rounded-xl shadow-xl px-8 py-12 space-y-6 text-center">
                    <img class="mx-auto" src="https://clouddevs.com/3dbay/files/preview/1280x1092/11643124653qtxi5jxlhkg64evoy1ze6ajngymavef7jy8les77y4uqg35nxyab64a2lu3pzld1qyiuybrq2lawnlz0eim5uy9f6caqn0ailles.png" alt="illustration" loading="lazy">
                </div>
            </div>
        </div>
    </div>
